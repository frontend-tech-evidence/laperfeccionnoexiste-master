import { IPdfCotizacion } from '../../../src/modules/cotizacion/domain/IPdfCotizacion'
...
class PdfCotizacion extends HTMLElement {
    constructor() {
        ...
        const modalidadPagoMembresiaCorta =
            packageInformation.modalidadPagoMembresia === 'mensual'
                ? 'mes'
                : 'año'
        const modalidadPagoImplementacionCorta =
            packageInformation.modalidadPagoImplementacion === 'mensual'
                ? 'mes'
                : 'año'
